            ...
            >
              ...
              <div className="caption-wrapper d-flex align-items-center">
                <div className="container-fluid text-start text-white px-5">
                  <div className="row">
                    <div
                      className={`col-lg-8 bannerleft ${
                        activeIndex === index ? "animate" : ""
                      }`}
                    >
                    ...
                    <div
                      className={`col-lg-4 homebannerright ${
                        activeIndex === index ? "animate" : ""
                      }`}
                    >
                      <p>
                        Ebix is a global enterprise technology powerhouse,
                        delivering transformative digital solutions that reshape
                        how businesses, institutions, and governments operate in
                        a connected world. With operations in 50+ countries and
                        a team of over 10,000 professionals, Ebix is a trusted
                        partner across diverse sectors including insurance,
                        finance, healthcare, education, travel, and public
                        services.
                      </p>
          ...
          <div className="carouselboxin position-relative d-flex align-items-center justify-content-between px-4">
            ...
            <button
              ...
              style={{
                ...
                pointerEvents:
                  activeIndex === totalItems - 1 ? "none" : "auto",
              }}
            >
