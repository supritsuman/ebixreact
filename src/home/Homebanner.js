...
const Homebanner = () => {
  ...
  // 🔹 This useEffect replaces your <script> tag
useEffect(() => {
                  ...
                  <div className="row">
                    <div className="col-lg-8 bannerleft position-relative">
                      <div className="banner-home-text">
                        ...
                        <div className="fade-wrapper">
                          <h1 id="line3"> & partnership</h1>
                        </div>
                      </div>
                    </div>
                    <div className="col-lg-4 homebannerright">
                      <p>
                        Ebix is a global enterprise technology powerhouse, delivering transformative digital solutions
                        that reshape how businesses, institutions, and governments operate in a connected world. With
                        operations in 50+ countries and a team of over 10,000 professionals, Ebix is a trusted partner
                        across diverse sectors including insurance, finance, healthcare, education, travel, and public
                        services.
                      </p>
